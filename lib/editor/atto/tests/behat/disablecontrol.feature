...
<<<<<<< HEAD
    And the "disabled" attribute of "button.atto_bold_button_bold" "css_element" should be set
    And the "disabled" attribute of "button.atto_italic_button_italic" "css_element" should be set
=======
...
<<<<<<< HEAD
    And the "disabled" attribute of "button.atto_bold_button_bold" "css_element" should not be set
    And the "disabled" attribute of "button.atto_italic_button_italic" "css_element" should not be set
=======
